...
const mockDownloads: DownloadItem[] = [
  {
    id: 1,
    name: "RedM Client",
    description: "Official RedM client for Red Dead Redemption 2 multiplayer modification",
    version: "1.0.2",
    size: "245 MB",
    downloads: 125430,
    rating: 4.9,
    category: "client",
    tags: ["Official", "Required", "Stable"],
    author: "RedM Team",
    lastUpdated: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000),
    featured: true,
    verified: true,
    downloadUrl: "#",
    changelog: "Fixed connection issues, improved stability",
  },
  {
    id: 2,
    name: "Wild West Roleplay Pack",
    description: "Complete roleplay modification pack with jobs, businesses, and custom scripts",
    version: "2.1.0",
    size: "1.2 GB",
    downloads: 45670,
    rating: 4.7,
  ...
  {
    id: 3,
    name: "Enhanced Weapons Pack",
    description: "Realistic weapon modifications with improved sounds and effects",
    version: "1.5.3",
    size: "89 MB",
    downloads: 23450,
    rating: 4.5,
    category: "resource",
    tags: ["Weapons", "Audio", "Effects", "Realistic"],
    author: "GunsmithMods",
  ...
  },
  {
    ...
    description: "Advanced server administration and monitoring tool for RedM servers",
    version: "3.0.1",
    size: "15 MB",
    downloads: 8920,
    rating: 4.8,
