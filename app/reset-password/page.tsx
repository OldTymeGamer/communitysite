              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    minLength={6}
                    className="bg-charcoal/50 border-amber-gold/30 text-sage-green placeholder:text-sage-green/50 focus:border-amber-gold focus:ring-amber-gold/20 pr-10"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-sage-green/60 hover:text-sage-green"
                  >
